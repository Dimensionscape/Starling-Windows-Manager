package starling.extensions.managers {
	...
	public class StarlingWindowConfiguration extends BaseStarlingWindow{
		...
		type: String = NativeWindowType.NORMAL,	systemChrome: String = NativeWindowSystemChrome.STANDARD, backgroundColor:uint = 0x0, resizable: Boolean = true, 
		...
		autoSizeStage: Boolean = true, autoActivate: Boolean = true) {			
			...
			this.starlingConfiguration = starlingConfiguration, this.id = this.starlingConfiguration.id, this.autoSizeStage = autoSizeStage, this.backgroundColor = backgroundColor;
